...
#define STRING_CONFIG_H_AUTHOR "(none, default config)" // Who made the changes.none, default config
...
#define CUSTOM_MACHINE_NAME "HyperCube is"
...
*/
//AKM PID CHANGE
  #define  DEFAULT_bedKp 855.61
  #define  DEFAULT_bedKi 153.60
  #define  DEFAULT_bedKd 1191.54
//
...
//#define NOZZLE_PARK_FEATURE
  ...
  #define NOZZLE_PARK_POINT { (X_MIN_POS + 10), (Y_MAX_POS - 10), 130 }
#endif
